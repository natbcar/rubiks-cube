...
if __name__ == '__main__':
    cube = [0, 19, 24, 17, 11, 15, 20, 13, 3, 23, 16, 21, 7, 22, 8, 6, 9, 14, 4, 2, 5, 18, 12, 10, 1, 33, 45, 46, 36, 40, 41, 42, 39, 29, 43, 34, 27, 47, 37, 31, 25, 38, 26, 44, 28, 35, 30, 48, 32]
    #print(solvetop(cube))
    #print(cube)
    #print(scramble(cube,10))
    #test(10)
    #testall(1)
    #cube = [0, 21, 14, 1, 10, 17, 22, 5, 2, 13, 18, 9, 6, 24, 11, 15, 4, 16, 7, 19, 12, 20, 3, 23, 8, 35, 33, 44, 45, 38, 40, 48, 41, 34, 32, 43, 25, 28, 47, 29, 37, 31, 36, 42, 30, 27, 39, 46, 26]
    #solvecube(cube)
